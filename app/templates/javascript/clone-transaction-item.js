let itemId = 0;
  ...
  $(function () {
    ...
    let rawClone = $('.transaction-item:first').clone().trigger("reset");
    ...
    $('#add-item').click(function () {
      // let newItem = $('.transaction-item:last').clone().insertAfter($('.transaction-item:last'));
      let newItem = $(rawClone).clone().insertAfter($('.transaction-item:last'));
