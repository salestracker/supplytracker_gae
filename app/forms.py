...
from wtforms import StringField, BooleanField, SelectField, FieldList, FormField, IntegerField, SubmitField, HiddenField
...
class ItemPurchaseForm(wtforms.Form):
  ...
  def validate(self, *args, **kwargs):
    if not super(type(self), self).validate():
      self.purchase_price.errors.append(super(type(self), self).errors)
      return False
...
class PurchaseTransactionForm(Form):
  ...
  def validate(self, **kwargs):
    ...
    if not super(type(self), self).validate():
      self.yyyy.errors += (super(type(self), self).errors, 'super not validated')
      return False
...
class ItemSaleForm(wtforms.Form):
  ...
  def validate(self, *args, **kwargs):
    if not super(type(self), self).validate():
      self.sale_price.errors += (super(type(self), self).errors,)
      return False
...
class FilterTableForm(Form):
  ...
  def validate(self, **kwargs):
    ...
    if not super(type(self), self).validate():
      self.id.errors += (super(type(self), self).errors, 'super not validated')
      return False
...
class PerPageForm(Form):
  ...
  def __init__(self, per_page, *args, **kwargs):
    ...
    super(type(self), self).__init__(*args, **kwargs)  # set per page
